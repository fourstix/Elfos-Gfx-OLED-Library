...
;             r7.1 - cursor y  (0 to 56) rows
;             r7.0 - cursor x  (0 to 122) columns
;
; Return: r7 - updated for next cursor position
;-------------------------------------------------------
            proc    gfx_adj_cursor
            glo     r7          ; get the current x position 
            adi     C_WIDTH     ; each character is 6 pixels wide
            plo     r7          ; save updated x value
            sdi     CURSOR_X    ; check if past limit of columns
            ...
            adi     C_HEIGHT    ; each character is 8 pixels tall
            phi     r7          ; save next y location
            sdi     CURSOR_Y    ; check of past limit of rows
