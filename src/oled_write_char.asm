...
;-------------------------------------------------------
            ...
            smi     C_OFFSET    ; convert to offset value (c value - space)
...
masks_done: call    oled_display_ptr  ; rd now points to lo bytes in buffer
            ...
            adi     DISP_WIDTH        ; hi bytes are in next line (128 bytes pre line)              
